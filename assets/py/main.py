...
from util import get_data_from_source  # استيراد الدالة من ملف util.py

app = Flask(__name__)

@app.route('/')
def home():
    # استدعاء الدالة من util.py
    data = get_data_from_source()
    return render_template('index.html', data=data)  # تمرير البيانات إلى HTML
